...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (price == null) {
            throw new IllegalArgumentException("Price requires value");
        }
        ...
        if (supplierName == null) {
            throw new IllegalArgumentException("Supplier name must be set");
        }

        String supplierPhoneNumber = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE_NUMBER);
        if (supplierPhoneNumber == null) {
            throw new IllegalArgumentException("Supplier phone number must be set");
        }
